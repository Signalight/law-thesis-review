// iet-law-thesis-review: DSH skill provider.
// Registers a ctx.skills provider that discovers skills/<name>/SKILL.md inside
// this package, mirroring @deepseek-ai/dsh-skill-filesystem so every agent
// preset's scope chain merges these skills.
import { readdir, readFile } from 'node:fs/promises'
import { fileURLToPath } from 'node:url'
import { dirname, join } from 'node:path'

const name = 'iet-law-thesis-review'
const inject = ['skills']
...
/** Parse the YAML frontmatter block of a SKILL.md into metadata + body. */
...
/** Discover packaged skill candidates by scanning the package's skills/ dir. */
...
/** Register the packaged iet-law-thesis-review provider on ctx.skills. */
function apply(ctx) {
